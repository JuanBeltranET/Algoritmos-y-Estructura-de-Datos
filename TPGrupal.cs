            ...
            while (ejecutar)
            {
                ...
                switch (opcion)
                {
                    ...
                    case "7":
                        ...
                        {
                            Console.Write("Ingrese el nombre del Pokémon a liberar: ");
                            ...
                            {
                                if (pokedex[i].nombre == nombreEliminar)
                                {
                                    pokedex.RemoveAt(i);
                                    eliminado = true;
                                    Console.WriteLine($"{nombreEliminar} fue liberado.");
                                    break;
                                }
                            }
                            ...
                            if (!eliminado)
                            {
                                Console.WriteLine($"{nombreEliminar} no se encontró en la pokédex.");
                            }
                        }
